...
Elm.Doubler = Elm.Doubler || {};
Elm.Doubler.make = function (_elm) {
   "use strict";
   _elm.Doubler = _elm.Doubler || {};
   if (_elm.Doubler.values)
   return _elm.Doubler.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
...
Elm.Main.make = function (_elm) {
   ...
   $moduleName = "Main",
   $Basics = Elm.Basics.make(_elm),
   $Doubler = Elm.Doubler.make(_elm),
   $Html = Elm.Html.make(_elm);
   var main = A2($Html.p,
   _L.fromArray([]),
   _L.fromArray([$Html.text($Basics.toString($Doubler.$double(2)))]));
